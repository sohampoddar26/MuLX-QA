    ...
    for idx, dat in enumerate(data):
        ...
        if len(labels)==3: #[political, country, mandatory]
                    ...
                    for high, spans in zip(highlights, keyword_spans):
                        for tup, span in zip(high, spans):
                            if tup[0] == lab:
                                ...
                                question = f'What does the text mention about the {lab} ?'
            ...
            for neg in negative_labels:
                ...
                question = f'What does the text mention about the {neg} ?'
                question = tokenizer(question).input_ids[1:-1]
                    ...
                    for high, spans in zip(highlights, keyword_spans):
                        ...
                        for tup, span in zip(high, spans):
                            ...
                            if tup[0] == lab:
                                ...
                                question = f'How {given_label[0]} and {lab} ?'
                                question = tokenizer(question).input_ids[1:-1]
            ...
            if dataset == 'caves':
                question = "What does the text mention about the none ?"
                #question = f"Why is \"none\" a reason for not taking vaccines?"
            else:
                question = "What does the text mention about the normal ?"
