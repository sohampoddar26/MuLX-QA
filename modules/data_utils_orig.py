    ...
    for idx, dat in enumerate(data):
        ...
        if len(labels)==3: #[political, country, mandatory]
                    ...
                    for high, spans in zip(highlights, keyword_spans):
                        ...
                        for tup, span in zip(high, spans):
                            ...
                            if tup[0] == label_for_prediction[0]:
                                ...
                                question = f'Given \"{given_labels[0]}\" and \"{given_labels[1]}\" are reasons, why is \"{label_for_prediction[0]}\" a reason for not taking vaccines?'
                                #question = f'{given_labels[0]} {given_labels[1]} {label_for_prediction[0]}'
                    ...
                    for high, spans in zip(highlights, keyword_spans):
                        ...
                        for tup, span in zip(high, spans):
                            ...
                            if tup[0] == lab:
                                ...
                                question = f'Given \"{given_label[0]}\" is a reason, why is \"{lab}\" a reason for not taking vaccines?'
                                #question = f'{given_label[0]} {lab}'
                                question = tokenizer(question).input_ids[1:-1]
            ...
            if dataset == 'caves':
                ...
                #question = "normal"
                question = f'Why is the sentiment \"normal\"?'
